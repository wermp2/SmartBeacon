...
/**
 * Activity for scanning and displaying available Smart Beacon advertisements.
 */
public class DeviceScanActivity extends ListActivity {
    ...
    private class SmartBeaconListAdapter extends BaseAdapter {
        ...
        public SmartBeacon getDevice(int position) {
        ...
        public View getView(int i, View view, ViewGroup viewGroup)
        {
            ...
            //Hie chönt me no züg us gäh, aber z meischte steit ou im logg
            ...
            if(smartBeacon != null) {
                try {
                    currentAdvertisement = smartBeacon.getCurrentAdvertisementParts();
                ...
                public void onScanResult (int callbackType, ScanResult result)
                {
                   ...
                   //smartBeacon device?
                    if (isSmartBeacon(result.getScanRecord().getDeviceName())) {
                        ...
                        {
                            //If the smart beacon is not in our list
