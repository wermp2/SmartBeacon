...
public class SmartBeacon
{
    ...
    /**
     * Returns the index number of a given part
     * @param obj advertisement part as json object
     * @return
     * @throws JSONException
     */
    ...
    /**
     * Checks if a given part is already in our list
     * @param obj the part to check
    ...
    /**
     * Sorts the collected advertisement parts according to their part number
     * @return
     * @throws JSONException
     */
    ...
    public String getCompleteAdvertisement() throws JSONException {
        ...
        for(JSONObject jsonPart : sortedJsonParts)
        {
            ...
            {
                //altitude
                part = keyTwo.get(0) + ": " + (String) innerObject.get(keyTwo.getString(0)) + "\n";
            }
            else
            {
                //Longitude, latitude
     ...
     * @return true if all parts have been found
     * @throws JSONException
     */
    ...
    /**
     * Return the number of found parts
     * @return
     */
