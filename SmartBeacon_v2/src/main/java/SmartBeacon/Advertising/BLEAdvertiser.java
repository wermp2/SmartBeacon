 ...
 */
public class BLEAdvertiser implements Runnable{
     ...
     * @param beaconDataCommand         The command used for setting the UUID, major and minor values
    ...
    /**
     *  Starts Low Energy advertising with parameter 3, which means that no connections are allowed.
     */
    ...
    /**
     * Runs the actual advertising of GPS coordinates, additional and beacon data
     */
    @Override
    public void run() {
        //start advertising
